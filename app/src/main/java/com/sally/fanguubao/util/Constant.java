...
public class Constant {
    ...
    public static final String DEBUG_FULISHE_DETAIL = "http://192.168.56.1:3333/api/fulishe/list?1=1";

    public static final String DEBUG_FENQI_IPHONE ="http://192.168.56.1:3333//api/iphone/list?tp=iphone";

    public static final String DEBUG_FENQI_MORE = "http://192.168.56.1:3333//api/iphone/list?tp=else";

    public static final String DEBUG_FENQI_CAR = "http://192.168.56.1:3333/api/car/info";

    public static final String DEBUG_FENQI_JD = "http://192.168.56.1:3333/api/gome/categories";
}
